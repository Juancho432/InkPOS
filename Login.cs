...
namespace InkPos
{
    public partial class Login : Form
    {
        ...
        private void button_ingresar_Click(object sender, EventArgs e)
        {
            ...
            //Empleado empleadoLogueado = VerificarCredenciales(usuario, contrasena);
            ...
            //    {
            //        FormAdministrador ventanaAdmin = new FormAdministrador();  // formulario para administrador
            //        ventanaAdmin.Show();
            //    }
            //    else
            //    {
            //        FormEmpleado ventanaEmpleado = new FormEmpleado();  // formulario para empleados
